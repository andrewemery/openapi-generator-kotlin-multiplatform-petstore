...
class FakeApi @UseExperimental(UnstableDefault::class) constructor(
    ...
    * @return void
    */
    suspend fun createXmlItem(xmlItem: XmlItem) : HttpResponse<Unit> {

        val localVariableAuthNames = listOf<String>()

        val localVariableBody = xmlItem
    ...
    */
    @Suppress("UNCHECKED_CAST")
    suspend fun fakeOuterCompositeSerialize(body: OuterComposite?) : HttpResponse<OuterComposite> {
    ...
    * @return void
    */
    suspend fun testBodyWithFileSchema(body: FileSchemaTestClass) : HttpResponse<Unit> {
    ...
    * @return void
    */
    suspend fun testBodyWithQueryParams(query: kotlin.String, body: User) : HttpResponse<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    suspend fun testClientModel(body: Client) : HttpResponse<Client> {
    ...
    */
    suspend fun testEnumParameters(enumHeaderStringArray: kotlin.Array<kotlin.String>?, enumHeaderString: kotlin.String?, enumQueryStringArray: kotlin.Array<kotlin.String>?, enumQueryString: kotlin.String?, enumQueryInteger: kotlin.Int?, enumQueryDouble: kotlin.Double?, enumFormStringArray: kotlin.Array<kotlin.String>?, enumFormString: kotlin.String?) : HttpResponse<Unit> {
        ...
        val localVariableQuery = mutableMapOf<String, List<String>>()
        enumQueryStringArray?.apply { localVariableQuery["enum_query_string_array"] = toMultiValue(this, "csv") }
    ...
    * @return void
    */
    suspend fun testInlineAdditionalProperties(param: kotlin.collections.Map<kotlin.String, kotlin.String>) : HttpResponse<Unit> {

        val localVariableAuthNames = listOf<String>()

        val localVariableBody = TestInlineAdditionalPropertiesRequest(param)
...
private class TestInlineAdditionalPropertiesRequest(val value: Map<kotlin.String, kotlin.String>) {
    ...
    */
    suspend fun testQueryParameterCollectionFormat(pipe: kotlin.Array<kotlin.String>, ioutil: kotlin.Array<kotlin.String>, http: kotlin.Array<kotlin.String>, url: kotlin.Array<kotlin.String>, context: kotlin.Array<kotlin.String>) : HttpResponse<Unit> {
        ...
        val localVariableQuery = mutableMapOf<String, List<String>>()
        pipe?.apply { localVariableQuery["pipe"] = toMultiValue(this, "pipe") }
