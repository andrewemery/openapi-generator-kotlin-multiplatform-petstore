...
This project includes the Kotlin multiplatform client generated by the [swagger-codegen](https://github.com/swagger-api/swagger-codegen) using the attached [petstore](petstore.yaml) specification.
